...
// // import { add_pro, filter_pro } from '../authentication/productSlice'
...
// //       // try{
// //         axios.post("http://127.0.0.1:8000/api/update-products", userdata, { headers: {
// //           'Content-Type': 'application/x-www-form-urlencoded',
// //         },}).then((response)=>{
...
// //       axios.post("http://127.0.0.1:8000/api/add-categories", userdata).then((response)=>{
// //         // console.log(response);
